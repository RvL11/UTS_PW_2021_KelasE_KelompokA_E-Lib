        ...
        echo '
            ...
            <body>
                <aside >
                    <div class="d-flex">
                        <div class="side-bar">
                            <h2 class="text-light text-center pt-2">E-Lib</h2>
                            <hr>
                            <div class="menu">
                                ...
                                <div class="content-menu">
                                    ...
                                    <a href="./pinjamShowPage.php" style="font-weight:600">Daftar Pinjam</a>
                                </div>
                                <div class="content-menu">
                                    <i class="fa fa-calendar-o"></i>
                                    <a href="./reservasiShowPage.php" style="font-weight:600">Daftar Reservasi</a>
                                </div>
                                <div class="content-menu">
                                    <i class="fa fa-user" style="margin-right: 4px;"></i>
                                    <a href="../page/profileShowPage.php" style="font-weight:600">Profile</a>
                                </div>
                                <div class="content-menu">
